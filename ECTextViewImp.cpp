...
{
    //cerr << "ECTextViewConfig AddStatusRow, left, right is: " << statusMsgLeft << ", " << statusMsgRight << endl;
    listStatusMsgsLeft.push_back(statusMsgLeft);
    listStatusMsgsRight.push_back(statusMsgRight);
    //cerr << "ECTextViewConfig AddStatusRow succesffuly pushed back" << endl;
...
//cout << "Waiting for key: \n";
        ...
        // just priint for now
        //Commenting out this code so that I can implement my own quit function
...
{
    //
    //cerr << "keyLastPressed is " << keyLastPressed << endl;
